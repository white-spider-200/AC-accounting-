...
@section('content')
    <div class="pagetitle">
        <h1>{{ __('Add Expenses Category') }}</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin">{{ __('Home') }}</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('expensescategories.index') }}">{{ __('ًWarehouses') }}</a></li>
                <li class="breadcrumb-item active">{{ __('Add Expenses Category') }}</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="label_en" id="label_en" class="form-control"
                            value="{{ old('label_en') }}" placeholder="Employees Salaries" required>
                    </div>
                </div>
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="label_ar" id="label_ar" class="form-control dir-rtl"
                            value="{{ old('label_ar') }}" placeholder="رواتب الموظفين" required>
                    </div>
                </div>
                <div class="form-group row mt-2">

            ...
            <form action="{{ route('products.store') }}" method="POST">
                <div class="tab-content pt-2">
                    <div class="tab-pane fade product-details show active" id="product-details" role="tabpanel">
                        ...
                        @csrf
                        <input type="hidden" name="product_id" id="product_id" value="{{ $tempId }}" />
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="label_en" id="label_en" class="form-control"
                                    value="{{ old('label_en') }}" placeholder="Product Name in English" required>
                            </div>
                        </div>
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="label_ar" id="label_ar" class="form-control"
                                    value="{{ old('label_ar') }}" placeholder=" اسم المنتج بالعربي " required>
                            </div>
                        </div>
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input type="number" step="any" name="price" id="price" class="form-control"
                                    value="{{ old('price') }}" placeholder="1000.50" min="0" required>
                            </div>
                        </div>
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input type="number" step="any" name="tax" id="tax" class="form-control"
                                    value="{{ @$allSetting['tax']->field_value_en }}" min="0" placeholder="16"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input type="number" step="any" name="stock_alert" id="stock_alert"
                                    class="form-control" value="{{ old('stock_alert', 0) }}" min="0"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input type="number" step="any" name="cost_price" id="cost_price"
                                    class="form-control" value="{{ old('cost_price') }}" min="0"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <textarea name="details_ar" rows="10" id="details_ar" placeholder="{{ __('Details in Arabic') }}"
                                    class="form-control">{{ old('details_ar') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <textarea name="details_en" rows="10" id="details_en" placeholder="{{ __('Details in English') }}"
                                    class="form-control">{{ old('details_en') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input class="form-control filepond" type="file" name="image" id="formFile"
                                    process="/admin/products/process?type=create&id={{ $tempId }}"
                                    toUpdate="imgproduct" afterUpload="/admin/products/images?id={{ $tempId }}"
                                    multiple>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        ...
                                        @foreach ($variant->children as $child)
                                            ...
                                            <input type="checkbox" name="{{ $variant->id }}-variants[]"
                                                ...
                                                realname="{{ app()->getLocale() == 'ar' ? $child-> label_ar : $child-> label_en }}" class="ml-10" />
                                        @endforeach
                                    </div>
                                @endforeach

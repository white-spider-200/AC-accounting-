                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-6">
                        <input type="date" name="real_date" id="real_date" class="form-control"
                            value="{{ old('real_date', $expense-> real_date) }}" required>
                    </div>
                </div>
                <div class="form-group row mt-2">
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-6">
                        <select name="expenses_categories_id" id="expenses_categories_id" class="form-select" required>
                            ...
                            <option value="{{ $category-> id}}" {{ ($category-> id == $expense-> expenses_categories_id) ? 'selected="true"':'' }}> {{ app()->getLocale() == 'ar' ? $category-> label_ar : $category-> label_en }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="label_en" id="label_en"
                            ...
                            value="{{ old('label_en', $expense-> label_en) }}" required>
                        @error('label_en')
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="label_ar" id="label_ar"
                            ...
                            value="{{ old('label_ar', $expense-> label_ar) }}" required>
                        @error('label_ar')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-6">
                        <textarea name="comment" id="comment"
                            ...
                            >{{ old('comment', $expense-> comment) }}</textarea>
                        @error('comment')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
